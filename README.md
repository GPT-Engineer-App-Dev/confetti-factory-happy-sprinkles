...
**Project**: confetti-factory-happy-sprinkles 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A fun app where I can create confetti 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/confetti-factory-happy-sprinkles.git
cd confetti-factory-happy-sprinkles
npm i
